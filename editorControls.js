...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (addMenuItemBtn) {
        addMenuItemBtn.addEventListener('click', () => {
            ...
            itemDiv.innerHTML = `
                <label for="menu-item-text-${itemCount}">Item ${itemCount} Text:</label>
                <input type="text" id="menu-item-text-${itemCount}" value="Item ${itemCount}">
                <label for="menu-item-link-${itemCount}">Item ${itemCount} Link:</label>
                <input type="text" id="menu-item-link-${itemCount}" value="#item${itemCount}">
                <button class="delete-item-btn action-button" data-item-id="${itemId}">Remove</button>
            `;
    ...
    if (addGalleryItemBtn) {
        addGalleryItemBtn.addEventListener('click', () => {
            ...
            itemDiv.className = 'editor-item-control';
            itemDiv.innerHTML = `
                <label for="gallery-img-src-${itemCount}">Image ${itemCount} URL:</label>
                <input type="text" id="gallery-img-src-${itemCount}" value="https://via.placeholder.com/200x150?text=Image${itemCount}">
                <label for="gallery-img-alt-${itemCount}">Alt Text ${itemCount}:</label>
                <input type="text" id="gallery-img-alt-${itemCount}" value="Image ${itemCount} description">
                <label for="gallery-text-${itemCount}">Card Text ${itemCount}:</label>
                <textarea id="gallery-text-${itemCount}">Descriptive text for image ${itemCount}.</textarea>
                <button class="delete-item-btn action-button" data-item-id="${itemId}">Remove</button>
            `;
            ...
            generatedCard.innerHTML = `
                <img src="https://via.placeholder.com/200x150?text=Image${itemCount}" alt="Image ${itemCount} description">
                <div class="card-text-content">Descriptive text for image ${itemCount}.</div>
            `;
    ...
    if (addFormFieldBtn) {
        addFormFieldBtn.addEventListener('click', () => {
            ...
            fieldDiv.innerHTML = `
                <label for="form-field-label-${fieldCount}">Field ${fieldCount} Label:</label>
                <input type="text" id="form-field-label-${fieldCount}" value="Field ${fieldCount}">
                <label for="form-field-type-${fieldCount}">Field ${fieldCount} Type:</label>
                ...
                <button class="delete-item-btn action-button" data-item-id="${fieldId}">Remove</button>
            `;
            ...
            labelElement.textContent = `Field ${fieldCount}:`;
            ...
            const appendFieldInput = (type) => {
                ...
                if (type === 'textarea') {
                    ...
                    span.textContent = `Option ${fieldCount}`;
