...
/////////////////////////////////////
// NOVO: Controle do Painel de Edição Colapsável
/////////////////////////////////////
function setupCollapsibleEditor() {
    ...
    if (toggleBtn && editorContainer) {
        toggleBtn.addEventListener('click', () => {
            editorContainer.classList.toggle('editor-collapsed');
        });
    }
}
...
<head>
    ...
    <style>
        /* Specific styles for the generated page */
...
function exibirCodigoGerado() {
    ...
    statusMessage.textContent = 'HTML code generated and displayed.';
...
function salvarLocalStorage() {
    ...
    const statusMessage = document.getElementById('status-message');
    statusMessage.textContent = 'Code saved to local storage!';
    statusMessage.className = 'status-message success show';
    setTimeout(() => statusMessage.className = 'status-message', 3000);
}
...
function carregarLocalStorage() {
    ...
    if (savedCode) {
        ...
        codePreview.style.display = 'block';
        statusMessage.textContent = 'Code loaded from local storage!';
        statusMessage.className = 'status-message success show';
    } else {
        statusMessage.textContent = 'No saved code found.';
...
function limparLocalStorage() {
    ...
    statusMessage.textContent = 'Saved code cleared!';
    statusMessage.className = 'status-message success show';
    setTimeout(() => statusMessage.className = 'status-message', 3000);
}
...
document.addEventListener('DOMContentLoaded', () => {
    setupTabs();
    setupCollapsibleEditor(); // Adiciona a nova funcionalidade na inicialização
